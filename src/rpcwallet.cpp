...
Value getaccountaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nResult:\n"
            "\"litecoinaddress\"   (string) The Litecoin account address\n"
            "\nExamples:\n"
...
Value setaccount(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("setaccount", "\"LWJvvrA8xFAZSMH16qLaPg4jMSbsafV8eB\" \"tabby\"")
            + HelpExampleRpc("setaccount", "\"LWJvvrA8xFAZSMH16qLaPg4jMSbsafV8eB\", \"tabby\"")
        );
...
Value getaccount(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("getaccount", "\"LWJvvrA8xFAZSMH16qLaPg4jMSbsafV8eB\"")
            + HelpExampleRpc("getaccount", "\"LWJvvrA8xFAZSMH16qLaPg4jMSbsafV8eB\"")
        );
...
Value sendtoaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 4)
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("sendtoaddress", "\"LWJvvrA8xFAZSMH16qLaPg4jMSbsafV8eB\" 0.1")
            + HelpExampleCli("sendtoaddress", "\"LWJvvrA8xFAZSMH16qLaPg4jMSbsafV8eB\" 0.1 \"donation\" \"seans outpost\"")
            + HelpExampleRpc("sendtoaddress", "\"LWJvvrA8xFAZSMH16qLaPg4jMSbsafV8eB\", 0.1, \"donation\", \"seans outpost\"")
        );
...
Value signmessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw runtime_error(
            ...
            + HelpExampleCli("signmessage", "\"LWJvvrA8xFAZSMH16qLaPg4jMSbsafV8eB\" \"my message\"") +
            "\nVerify the signature\n"
            + HelpExampleCli("verifymessage", "\"LWJvvrA8xFAZSMH16qLaPg4jMSbsafV8eB\" \"signature\" \"my message\"") +
            "\nAs json rpc\n"
            + HelpExampleRpc("signmessage", "\"LWJvvrA8xFAZSMH16qLaPg4jMSbsafV8eB\", \"my message\"")
        );
...
Value getreceivedbyaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            + HelpExampleCli("getreceivedbyaddress", "\"LWJvvrA8xFAZSMH16qLaPg4jMSbsafV8eB\"") +
            "\nThe amount including unconfirmed transactions, zero confirmations\n"
            + HelpExampleCli("getreceivedbyaddress", "\"LWJvvrA8xFAZSMH16qLaPg4jMSbsafV8eB\" 0") +
            "\nThe amount with at least 6 confirmation, very safe\n"
            + HelpExampleCli("getreceivedbyaddress", "\"LWJvvrA8xFAZSMH16qLaPg4jMSbsafV8eB\" 6") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("getreceivedbyaddress", "\"LWJvvrA8xFAZSMH16qLaPg4jMSbsafV8eB\", 6")
       );
...
Value sendfrom(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 3 || params.size() > 6)
        throw runtime_error(
            ...
            + HelpExampleCli("sendfrom", "\"\" \"LWJvvrA8xFAZSMH16qLaPg4jMSbsafV8eB\" 0.01") +
            "\nSend 0.01 from the tabby account to the given address, funds must have at least 6 confirmations\n"
            + HelpExampleCli("sendfrom", "\"tabby\" \"LWJvvrA8xFAZSMH16qLaPg4jMSbsafV8eB\" 0.01 6 \"donation\" \"seans outpost\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendfrom", "\"tabby\", \"LWJvvrA8xFAZSMH16qLaPg4jMSbsafV8eB\", 0.01, 6, \"donation\", \"seans outpost\"")
        );
...
Value sendmany(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 4)
        throw runtime_error(
            ...
            "    {\n"
            "      \"address\":amount   (numeric) The litecoin address is the key, the numeric amount in btc is the value\n"
            "      ,...\n"
            "    }\n"
            ...
            + HelpExampleCli("sendmany", "\"tabby\" \"{\\\"LWJvvrA8xFAZSMH16qLaPg4jMSbsafV8eB\\\":0.01,\\\"LbhhnRHHVfP1eUJp1tDNiyeeVsNhFN9Fcw\\\":0.02}\"") +
            "\nSend two amounts to two different addresses setting the confirmation and comment:\n"
            + HelpExampleCli("sendmany", "\"tabby\" \"{\\\"LWJvvrA8xFAZSMH16qLaPg4jMSbsafV8eB\\\":0.01,\\\"LbhhnRHHVfP1eUJp1tDNiyeeVsNhFN9Fcw\\\":0.02}\" 6 \"testing\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendmany", "\"tabby\", \"{\\\"LWJvvrA8xFAZSMH16qLaPg4jMSbsafV8eB\\\":0.01,\\\"LbhhnRHHVfP1eUJp1tDNiyeeVsNhFN9Fcw\\\":0.02}\", 6, \"testing\"")
        );
...
Value addmultisigaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
    {
        string msg = "addmultisigaddress nrequired [\"key\",...] ( \"account\" )\n"
            ...
            + HelpExampleCli("addmultisigaddress", "2 \"[\\\"LWJvvrA8xFAZSMH16qLaPg4jMSbsafV8eB\\\",\\\"LbhhnRHHVfP1eUJp1tDNiyeeVsNhFN9Fcw\\\"]\"") +
            "\nAs json rpc call\n"
            + HelpExampleRpc("addmultisigaddress", "2, \"[\\\"LWJvvrA8xFAZSMH16qLaPg4jMSbsafV8eB\\\",\\\"LbhhnRHHVfP1eUJp1tDNiyeeVsNhFN9Fcw\\\"]\"")
        ;
...
Value walletlock(const Array& params, bool fHelp)
{
    if (pwalletMain->IsCrypted() && (fHelp || params.size() != 0))
        throw runtime_error(
            ...
            + HelpExampleCli("sendtoaddress", "\"LWJvvrA8xFAZSMH16qLaPg4jMSbsafV8eB\" 1.0") +
