...
static Checkpoints::MapCheckpoints mapCheckpoints =
	...
	(  0, uint256("0x40563a082842bc8d7b7036552ae8e232bf503226bc6a8fb5e46c9e706f32d6a5"))
        ;
...
public:
    CMainParams() {
        ...
        vAlertPubKey = ParseHex("040184999fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9");
        nDefaultPort = 2006;
         ...
         *   vMerkleTree: 4a5e1e
         */
        const char* pszTimestamp = "De papa van Merel maakt een coin voor haar op 4 september 2015";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("040184999fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime    = 1441363588;
        genesis.nBits    = 0x1e0ffff0;
        genesis.nNonce   = 352966;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x40563a082842bc8d7b7036552ae8e232bf503226bc6a8fb5e46c9e706f32d6a5"));
        assert(genesis.hashMerkleRoot == uint256("0x6f88b9a6d527edb6d78b4eee5e0f51f272be0c1da7a916890a888108adfcf944"));
