...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("validateaddress", "\"LWJvvrA8xFAZSMH16qLaPg4jMSbsafV8eB\"")
            + HelpExampleRpc("validateaddress", "\"LWJvvrA8xFAZSMH16qLaPg4jMSbsafV8eB\"")
        );
...
Value createmultisig(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
    {
        string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            + HelpExampleCli("createmultisig", "2 \"[\\\"LWJvvrA8xFAZSMH16qLaPg4jMSbsafV8eB\\\",\\\"171sgjn4YtPu27adkKGrdDwzRTxnRkBfKV\\\"]\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("createmultisig", "2, \"[\\\"LWJvvrA8xFAZSMH16qLaPg4jMSbsafV8eB\\\",\\\"171sgjn4YtPu27adkKGrdDwzRTxnRkBfKV\\\"]\"")
        ;
...
Value verifymessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            ...
            "\nAs json rpc\n"
            + HelpExampleRpc("verifymessage", "\"LWJvvrA8xFAZSMH16qLaPg4jMSbsafV8eB\", \"signature\", \"my message\"")
        );
