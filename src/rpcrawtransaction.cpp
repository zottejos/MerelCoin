...
Value listunspent(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 3)
        throw runtime_error(
            ...
            + HelpExampleCli("listunspent", "6 9999999 \"[\\\"LWJvvrA8xFAZSMH16qLaPg4jMSbsafV8eB\\\",\\\"LbhhnRHHVfP1eUJp1tDNiyeeVsNhFN9Fcw\\\"]\"")
            + HelpExampleRpc("listunspent", "6, 9999999 \"[\\\"LWJvvrA8xFAZSMH16qLaPg4jMSbsafV8eB\\\",\\\"LbhhnRHHVfP1eUJp1tDNiyeeVsNhFN9Fcw\\\"]\"")
        );
...
Value createrawtransaction(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw runtime_error(
            ...
            "    {\n"
            "      \"address\": x.xxx   (numeric, required) The key is the litecoin address, the value is the btc amount\n"
            "      ,...\n"
            "    }\n"
